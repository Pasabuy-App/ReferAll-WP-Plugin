<?php
    ...
    /*
        ...
        Text Domain:  referall-wp-plugin
    ...
    */
    ...
    define("RA_PLUGIN_PATH", plugin_dir_path( __FILE__ ) );
    ...
    include_once ( RA_PLUGIN_PATH . '/includes/core/dbhook.php' );

    //Includes assets if page is defined.
    include_once ( RA_PLUGIN_PATH . '/includes/core/assets.php' );
